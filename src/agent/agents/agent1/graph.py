"""LangGraph graph construction for agent1."""
...
from agent.agents.agent1.nodes import make_agent_node, make_tool_node
from agent.agents.agent1.state import Agent1State
from agent.agents.agent1.tools import ALL_TOOLS
...
def build_graph(settings: Settings) -> Any:
    """Build and compile the LangGraph agent graph for agent1.
