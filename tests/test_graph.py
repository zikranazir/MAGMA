"""Tests for graph construction (agent.agents.agent1.graph)."""
...
from agent.agents.agent1.graph import build_graph, should_continue
...
class TestShouldContinue:
    def test_returns_tools_when_tool_calls_present(self) -> None:
        ...
        state: Agent1State = {"messages": [msg]}
...
class TestBuildGraph:
    def test_returns_compiled_graph(
        ...
        with patch(
            "agent.agents.agent1.graph.get_chat_model", return_value=mock_chat_model
        ):
